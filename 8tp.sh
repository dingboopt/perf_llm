...
$CMD  2>&1 > test_single_${HOSTNAME}_${GPU_ID}_${GLOBAL_BATCH_SIZE}_${MICRO_BATCH_SIZE}_${NLAYERS}_${NHIDDEN}_${NHEADS}_${SEQ_LEN}/test_single_${GPU_ID}_${GLOBAL_BATCH_SIZE}_${MICRO_BATCH_SIZE}_${NLAYERS}_${NHIDDEN}_${NHEADS}_${SEQ_LEN}.$DATE.$HOUR.log
